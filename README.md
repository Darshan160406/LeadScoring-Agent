...
**Live Demo:** [Launch App](https://7tc5hgbwv5s999gq5mjtxb.streamlit.app)  
**GitHub Repository:** [View Repository](https://github.com/Darshan160406/LeadScoring-Agent)
...
Commit this README, deploy once, submit, and **do not change anything afterward**.

If you want:

* a **submission email check**, or
* **possible interviewer follow-up questions**,

tell me — otherwise you're done.
